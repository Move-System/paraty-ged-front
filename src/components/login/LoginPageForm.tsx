  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center w-full h-screen bg">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col items-center w-full">
        <div className="w-1/2">
          <Input placeholder="Email" className="w-full mt-3 mb-1" {...register('email')} />
          {errors.email && (
        ...
        <div className="w-1/2 mt-4">
          <a
            ...
            className="text-sm text-gray-500 hover:underline hover:text-gray-600"
          >
            Esqueceu sua senha?
          </a>
        </div>
        ...
        {errorMessage && (
          <div className="w-1/2 mt-4 text-left text-sm text-red-500">{errorMessage}</div>
        )}

        <Button type="submit" className="w-1/2 mt-4" disabled={isSubmitting}>
